...
const Treadmills = ({incrementItemCount}) => {
    const allProducts = {
        'Treadmills': [
    ...
    return (
        <Shop defaultActiveItem="Treadmills" allProducts={allProducts} categories={categories} incrementItemCount={incrementItemCount}/>
    );
}
