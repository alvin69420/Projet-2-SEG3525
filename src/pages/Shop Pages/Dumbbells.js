...
const Dumbbells = ({incrementItemCount}) => {
    const allProducts = {
        'Benches': [
    ...
    return (
        <Shop defaultActiveItem="Dumbbells" allProducts={allProducts} categories={categories} incrementItemCount={incrementItemCount}/>
    );
}
